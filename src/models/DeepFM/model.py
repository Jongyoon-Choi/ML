...
class DeepFM(nn.Module):
    def __init__(self, num_users, num_items, feature_sizes, embedding_dim, hidden_dim):
        ...
        self.feature_embeddings = [nn.Embedding(feature_size, embedding_dim) for feature_size in self.feature_sizes]
